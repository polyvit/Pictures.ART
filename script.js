...
/* harmony import */ var _modules_checkTestInputs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/checkTestInputs */ "./src/js/modules/checkTestInputs.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_checkTestInputs__WEBPACK_IMPORTED_MODULE_3__["default"])("[name='name']");
  Object(_modules_checkTestInputs__WEBPACK_IMPORTED_MODULE_3__["default"])("[name='message']");
...
var accordion = function accordion(pSel, divSel) {
  var allP = document.querySelectorAll(pSel),
      blocks = document.querySelectorAll(divSel); // allP.forEach((p) => {
  ...
  allP.forEach(function (p) {
    p.addEventListener("click", function () {
      if (!this.classList.contains("active")) {
        allP.forEach(function (p) {
          return p.classList.remove("active", "active-style");
        });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(menuSel, burgerSel) {
  var menuElem = document.querySelector(menuSel),
...
/***/ "./src/js/modules/checkTestInputs.js":
/*!*******************************************!*\
  !*** ./src/js/modules/checkTestInputs.js ***!
  \*******************************************/
/*! exports provided: default */
...
var checkTestInputs = function checkTestInputs(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (checkTestInputs);
...
var drop = function drop() {
  var uploadInputs = document.querySelectorAll("[name='upload']"); // Отменяем стандартное поведение браузера по открытию фото
...
var filter = function filter() {
  ...
  var checkClassAndShow = function checkClassAndShow(e) {
    ...
    if (targetClass == "grandmother" || targetClass == "granddad") {
      ...
      document.getElementsByClassName(targetClass).forEach(function (photo) {
        return showPhotos(photo);
      });
    }
  };

  var filterByBtn = function filterByBtn() {
...
var forms = function forms() {
  ...
  uploadInputs.forEach(function (item, index) {
    item.addEventListener("input", function () {
      ...
      var button = item.previousElementSibling.previousElementSibling;
  ...
  forms.forEach(function (form) {
    form.addEventListener("submit", function (e) {
      e.preventDefault(); // Элемент, в котором будет картинка и текст

      var statusElement = document.createElement("div");
      statusElement.classList.add("status");
      form.parentNode.appendChild(statusElement); // Скрываем форму (вместо нее будет изображение)

      form.classList.add("animated", "fadeOutUp");
      setTimeout(function () {
        form.style.display = "none";
      }, 400); // Элемент картинки

      var statusImg = document.createElement("img");
      statusImg.setAttribute("src", message.spinner);
      statusImg.classList.add("animated", "fadeInUp");
      statusElement.appendChild(statusImg); // Элемент текстовой подписи
      ...
      var api;
      form.closest(".popup-design") || form.classList.contains("upload_form") ? api = path.designer : api = path.question;
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    var matrix = "+7 (___) ___ __ __",
        ...
        // 7 (1)
    val = this.value.replace(/\D/g, ""); // 7921
...
var modals = function modals() {
  ...
  function bindModal(elSelector, modalSelector, closeSelector) {
    var destroy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var allElements = document.querySelectorAll(elSelector),
...
var pictureSize = function pictureSize(imgSelector) {
  var blocks = document.querySelectorAll(imgSelector); // function showImg(block) {
  ...
  function showHideImg(event) {
    ...
    img.src = event.type === "mouseover" ? img.src.slice(0, -4) + "-1.png" : img.src.slice(0, -6) + ".png";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var scrolling = function scrolling(upSel) {
  var upElem = document.querySelector(upSel),
      menuElem = document.querySelector(".header-menu"); // Отображение стрелки для возврата наверх
  ...
  menuElem.addEventListener("click", function (e) {
    ...
    if (e.target.classList.contains("menu-link")) {
      var href = e.target.firstElementChild.getAttribute("href");
...
var showMoreStyles = function showMoreStyles(elSelector, wrapper) {
  var btn = document.querySelector(elSelector);
...
var sliders = function sliders(slideSelector, dir, prev, next) {
  var slideIndex = 1;
  var paused; // Нужно ли остановить автоматическое переключение слайдов
  ...
  } catch (e) {} // Анимационная смена слайдов
